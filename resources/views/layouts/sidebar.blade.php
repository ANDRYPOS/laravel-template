<aside
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto {{-- h-sidenav --}} grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ request()->routeIs('view-data') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 ' : '' }}py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    href="{{ url('data') }}">
                    <div
                        class="{{ request()->routeIs('view-data') ? 'bg-gradient-to-tl from-blue-600 to-cyan-400 ' : '' }}shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
