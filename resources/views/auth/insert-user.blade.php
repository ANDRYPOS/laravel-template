...
@section('content')
    ...
    <div class="w-full px-6 mx-auto mb-4">
        <a
            ...
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Insert User</h5>
            <form class="w-full max-w-lg" method="post" action="{{ url('store-user') }}" enctype="multipart/form-data">
                @csrf
                {{-- fullname --}}
                <div class="flex
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <div class="relative">
                            <select
                                ...
                                <option class="cursor-pointer" value="admin">Admin</option>
                                <option class="cursor-pointer" value="staff">Staff</option>
                                <option class="cursor-pointer" value="mahasiswa">Mahasiswa</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <div class="flex items-center justify-center mt-2">
                            <label for="dropzone-file" class="file-upload">
                                <input id="dropzone-file" type="file" name="avatar" onchange="fileSelected(event)" />
